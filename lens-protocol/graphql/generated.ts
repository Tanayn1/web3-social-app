...
export type AuthenticateMutation = { __typename?: 'Mutation', authenticate: { __typename?: 'AuthenticationResult', accessToken: any, identityToken: any, refreshToken: any } };
...
export type HandleToProfileIdQuery = { __typename?: 'Query', profile?: { __typename?: 'Profile', id: any } | null };
...
export type RefreshMutation = { __typename?: 'Mutation', refresh: { __typename?: 'AuthenticationResult', accessToken: any, identityToken: any, refreshToken: any } };
...
export function useChallengeSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<ChallengeQuery, ChallengeQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
...
export function useGenerateLensApiRelayAddressSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<GenerateLensApiRelayAddressQuery, GenerateLensApiRelayAddressQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
...
export function useHandleToAddressSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<HandleToAddressQuery, HandleToAddressQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
...
/**
 * __useHandleToProfileIdQuery__
 *
 * To run a query within a React component, call `useHandleToProfileIdQuery` and pass it any options that fit your needs.
 * When your component renders, `useHandleToProfileIdQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useHandleToProfileIdQuery({
 *   variables: {
 *      request: // value for 'request'
 *   },
 * });
 */
export function useHandleToProfileIdQuery(baseOptions: Apollo.QueryHookOptions<HandleToProfileIdQuery, HandleToProfileIdQueryVariables> & ({ variables: HandleToProfileIdQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<HandleToProfileIdQuery, HandleToProfileIdQueryVariables>(HandleToProfileIdDocument, options);
      }
export function useHandleToProfileIdLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<HandleToProfileIdQuery, HandleToProfileIdQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<HandleToProfileIdQuery, HandleToProfileIdQueryVariables>(HandleToProfileIdDocument, options);
        }
export function useHandleToProfileIdSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<HandleToProfileIdQuery, HandleToProfileIdQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<HandleToProfileIdQuery, HandleToProfileIdQueryVariables>(HandleToProfileIdDocument, options);
        }
export type HandleToProfileIdQueryHookResult = ReturnType<typeof useHandleToProfileIdQuery>;
export type HandleToProfileIdLazyQueryHookResult = ReturnType<typeof useHandleToProfileIdLazyQuery>;
export type HandleToProfileIdSuspenseQueryHookResult = ReturnType<typeof useHandleToProfileIdSuspenseQuery>;
export type HandleToProfileIdQueryResult = Apollo.QueryResult<HandleToProfileIdQuery, HandleToProfileIdQueryVariables>;
...
export function useOwnedHandlesSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<OwnedHandlesQuery, OwnedHandlesQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
